...
from app import encode_image, analyze_image_with_query
...
def process_inputs(audio_filepath, image_filepath):
    """Process user inputs (audio and image) and return transcribed text, AI doctor's response, and voice output."""
